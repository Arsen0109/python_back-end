...
def get_src_prefix():
    if running_under_virtualenv():
        src_prefix = os.path.join(sys.prefix, 'python_back-end')
    else:
        # FIXME: keep python_back-end in cwd for now (it is not a temporary folder)
        try:
            src_prefix = os.path.join(os.getcwd(), 'python_back-end')
        except OSError:
