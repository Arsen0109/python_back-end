...
src = partial(
    Option,
    '--python_back-end', '--source', '--source-dir', '--source-directory',
    dest='src_dir',
    metavar='dir',
    default=get_src_prefix(),
    help='Directory to check out editable projects into. '
    'The default in a virtualenv is "<venv path>/python_back-end". '
    'The default for global installs is "<current dir>/python_back-end".'
)  # type: Callable[..., Option]
